...
| donations.netwrok   | `String` | `false`    |         | `network` indicates the network(s) the wallet address is located. Ex: donations.zilliqa or donations.ethereum along with a wallet address |
